...
export default function Hero() {
  return (
    <div className="flex justify-between items-center pt-20  w-full h-full rounded-4xl bg-gray-400 p-10 ">
      <div className="flex flex-col gap-1">
        <div className="flex items-center justify-start w-full">
          <h1 className="text-white text-6xl lg:text-8xl xl:text-9xl">
            Menoti Filho
          </h1>
        </div>
        <p className="text-amber-100 max-w-lg ml-2 text-xs lg:text-md xl:text-lg">
